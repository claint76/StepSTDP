...
It quantify the weight_change(trace)-time curve (which is exponential, blue curve in the top image) to step curve(orange curve in the top image). The left image is linear-cut quantization while the right image is nonlinear-cut quantization.
